...
function Projects() {
    return (
        <div id="projects" className='flex flex-col w-full bg-[#f9fbfc]'>
            ...
            <div className="flex flex-col px-14 md:px-0 space-y-40">
                ...
                <div className='flex flex-col-reverse flex-wrap md:flex-row md:justify-evenly pt-12'>
                    ...
                    <div className="flex flex-col mt-10 md:mt-0 md:items-end">
                        <div className='flex flex-col md:items-end my-2'>
                            <p className='text-base text-purple-700'>Project</p>
                            <p className='text-4xl font-medium text-purple-800'>Lostrace</p>
                        </div>
                        <div className="flex flex-col text-purple-900/95 bg-purple-100/60 md:w-96 rounded-lg p-4">
                            Reverse Image Search based Tracking App with efficient Flex-Search Algorithm on WCD Lost-Child Data.</div>
                        ...
                        <div className='flex space-x-4 py-2'>
                            <a href="https://github.com/ML9-FORCES/Lostrace-Frontend" target="_blank" rel="noopener noreferrer">
                            ...
                            <a href="https://lostrace.vercel.app/" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-purple-700 duration-200 hover:text-custom-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                                </svg>
                            </a>
                ...
                <div className='flex flex-col-reverse flex-wrap md:flex-row md:justify-evenly'>
                    ...
                    <div className="flex flex-col mt-10 md:mt-0 md:items-end">
                        ...
                        <div className='flex space-x-4 py-2'>
                            ...
                            <a href="https://matrixiocommunity.vercel.app/" target="_blank" rel="noopener noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-purple-700 duration-200 hover:text-custom-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                                </svg>
                            </a>
                ...
                <div className='flex flex-col flex-wrap md:flex-row md:justify-evenly'>
                    ...
                    <div className="flex md:w-[38rem] md:h-[22rem] overflow-hidden duration-700 rounded-lg shadow-xl hover:shadow-2xl">
                        <Image src={Portfolio} objectFit='contain' alt='Portfolio' />
                    </div>
                </div>
