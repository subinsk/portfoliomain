...
function Accomplishments() {
    return <div className='flex flex-col w-full'>
        ...
        <div className='flex flex-col items-center'>
            <div className='flex justify-evenly border-0 rounded-md shadow-lg space-x-20 bg-blue-100/30 max-w-[48.2rem]'>
                <Tooltip tooltipText="Click to view Certificate">
                    <a href="https://www.dropbox.com/s/by789h6jrejo3is/HackJNU%202.0%20%3A%20Subin%20S%20K%20Cerificate.pdf?dl=0" target="_blank" rel="noopener noreferrer">
                        <div className="flex w-[22rem] h-[17rem] overflow-hidden duration-700 rounded-lg shadow-xl hover:shadow-2xl saturate-0 hover:saturate-150">
                            <Image src={HackJNU} alt='HackJNU' objectFit='cover' />
                        </div>
                    </a>
                </Tooltip>
                <div className='flex flex-col items-end my-2 p-6'>
                    <p className='text-xl font-medium bg-gradient-to-r from-purple-700 to-blue-700 bg-clip-text text-transparent'>WINNER</p>
                    <p className='text-[3rem] font-medium bg-gradient-to-r from-blue-800 to-custom-cyan bg-clip-text text-transparent'>HackJNU 2.0</p>
                </div>
            </div>
            <div className='flex justify-evenly border-0 rounded-md shadow-lg space-x-15 bg-blue-100/30 my-32 max-w-[48.2rem]'>
                <div className='flex flex-col items-start my-2 p-6'>
                    <p className='text-xl font-medium bg-gradient-to-r from-purple-700 to-blue-700 bg-clip-text text-transparent'>RUNNER-UP</p>
                    <p className='text-[3rem] font-medium bg-gradient-to-r from-blue-800 to-custom-cyan bg-clip-text text-transparent'>Cicada 3301:Reinvented</p>
                </div>
                <Tooltip tooltipText="Click to view Certificate">
            ...
            <div className='flex justify-evenly border-0 rounded-md shadow-lg space-x-20 bg-blue-100/30 max-w-[48.2rem]'>
                ...
                <div className='flex flex-col items-end my-2 p-6'>
                    <p className='text-xl font-medium bg-gradient-to-r from-purple-700 to-blue-700 bg-clip-text text-transparent'>RUNNER UP</p>
                    <p className='text-[2.8rem] font-medium bg-gradient-to-r from-blue-800 to-custom-cyan bg-clip-text text-transparent'>Octahacks 2.0</p>
                </div>
            </div>
        </div>
    </div>
