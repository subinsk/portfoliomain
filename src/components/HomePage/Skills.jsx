...
function Skills() {
    ...
    return (
        <div id="skills" className='w-full flex flex-col'>
            <p className='bg-gradient-to-r from-custom-purple-300 to-custom-cyan bg-clip-text text-transparent flex text-4xl md:text-5xl pt-20 px-9 md:p-12 font-medium after:content-[""] after:relative after:inline-block after:w-1/5 md:after:w-2/5 after:h-[1px] after:bg-custom-purple-50 after:mt-5 md:after:mt-7 after:ml-4'> I&apos;m good at</p>
